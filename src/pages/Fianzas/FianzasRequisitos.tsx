                ...
                <div className="requisitos-row">
                    ...
                    <div className="requisitos-col mid">
                        ...
                        <ol>
                            ...
                            <li>Declaración ISR con Acuse y Anexos 2024.</li>
                            <li>Balance General y Estado de Resultados al 31 de Diciembre del 2024.</li>
                            <li>Balance General y Estado de Resultados Parciales Internos 2025 (No Mayor a 6 Meses). Con Leyenda de validacion (*Abajo citada). Deberán Estar en Papel Membretado y Firmados Por el Representante Legal y Contador Público, anexando copia de su Cedula Profesional.</li>
                        </ol>
                        <h3>Sus obligados</h3>
                        <ol>
                            ...
                            <li>Boleta Predial del Año 2025.</li>
                            <li>Certificado de Libertad o Gravamen del Año 2025.</li>
                            <li>Acta de Matrimonio (En caso de ser Casado), Identificación con Fotografía (INE) del Cónyuge.</li>
                        </ol>
                        <div className="actions">
                            <a className="btn-fianzas" href="/clientes-nuevo-ingreso-2025-pmoral.pdf" target="_blank">Imprimir</a>
                ...
                <div className="requisitos-row">
                    ...
                    <div className="requisitos-col mid">
                        <ol>
                            ...
                            <li>CURP.</li>
                            <li>RFC y/o Constancia de Situación Fiscal.</li>                         
                            <li>Declaración ISR y Acuse 2024.</li>
                            <li>Balance General y Estado de Resultados al 31 de Diciembre del 2024.</li>
                            <li>Balance General y Estado de Resultados Parciales Internos 2025 (No mayores a 6 meses). Con Leyenda de validación (*Abajo citada). Deberán Estar en Papel Membretado y Firmados Por el Representante Legal y Contador Público, anexando copia de su Cédula Profesional.</li>
                    ...
                    <div className="actions">
                        <a href='/clientes-nuevo-ingreso-2025-pfisica.pdf' target="_blank" className="btn-fianzas">Imprimir</a>
