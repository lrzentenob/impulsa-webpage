        ...
        <>
            ...
            <section className="fianzas-valid">
                ...
                <div className="fianza-valid-content">
                    ...
                    <ul>
                        <li><p><FontAwesomeIcon icon={faCircleCheck} size='1x' className="icon" /> <Link to='https://fianzas.aserta.com.mx/misFianzasInsurgentesIP17/ConsultaLineCaptura.jsp'>Aseguradora Insurgentes</Link></p></li>
                        <li><p><FontAwesomeIcon icon={faCircleCheck} size='1x' className="icon" /> <Link to='https://fianzas.aserta.com.mx/misFianzasAsertaIP17/ConsultaLineCaptura.jsp'>Aseguradora Aserta</Link></p></li>
                        <li><p><FontAwesomeIcon icon={faCircleCheck} size='1x' className="icon" /> <Link to='http://apps.dorama.mx/validafianza/sitios/default.aspx?AspxAutoDetectCookieSupport=1'>Afianzadora Dorama</Link></p></li>
                        ...
                        <li><p><FontAwesomeIcon icon={faCircleCheck} size='1x' className="icon" /> <Link to='http://187.188.115.53/aFi_validafianza/Sitios/Default.aspx'>Afianzadora Fiducia</Link></p></li>
                        ...
                        <li><p><FontAwesomeIcon icon={faCircleCheck} size='1x' className="icon" /> <Link to='https://www.iconfianza.com.mx/iConfianza2014/validacion/ValLineaValidacion.aspx'>Aseguradora Chubb Fianzas Monterrey</Link></p></li>
                        ...
                        <li><p><FontAwesomeIcon icon={faCircleCheck} size='1x' className="icon" /> <Link to='https://dynamic.tmhcc.com/validation/sitios/default.aspx'>Afianzadora Tokio Marine</Link></p></li>
